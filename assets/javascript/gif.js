$(document).ready(function () {
    var gifCategories = ["Harry Potter", "Cats", "Dogs", "Babies","Eeyore","Pooh","Dinosaur","Lion","Iron Giant", "Frozen", "Life of Pets"];
    ...
    $(document).on("click", ".imageC", playGifs);
